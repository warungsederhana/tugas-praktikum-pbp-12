...
//inisialisasi variable dengan id yang ada di layout
        ...
        databaseReference = FirebaseDatabase.getInstance("https://praktikum12-dd86b-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference().child("mhs").child(nim);
