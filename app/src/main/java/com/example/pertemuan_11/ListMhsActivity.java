...
public class ListMhsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance("https://praktikum12-dd86b-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference("mhs");
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                myAdapter.setOnItemClickListener(new MyAdapter.OnItemClickListener() {
                    ...
                    public void onItemClick(int position) {
                        ...
                        startActivity(new Intent(ListMhsActivity.this,
                                EditMhsActivity.class).putExtra("nim", nim));
                    }
                });
            }
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(ListMhsActivity.this,
                        "Maaf Terjadi kesalahan... coba beberapa saat lagi !", Toast.LENGTH_SHORT).show();
            }
        });
